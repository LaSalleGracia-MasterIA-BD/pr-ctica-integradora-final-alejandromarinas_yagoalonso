...
| 5 | Automatizacion de procesos (alertas + informes + watcher como servicio) | specs/automatizacion-alertas.md | design/automatizacion-alertas.md | tasks/automatizacion-alertas.md | done (Feature 15: watcher ✓ + GET /api/v1/alerts ✓ + GET /api/v1/reports/daily ✓ + script CLI `daily_report.py` idempotente byte-a-byte ✓ + vista dashboard "Alertas" ✓; 60 tests nuevos verdes) | M |
| 6 | Monitorizacion y calidad de datos (logging centralizado + validacion + alertas) | specs/automatizacion-alertas.md | design/automatizacion-alertas.md | tasks/automatizacion-alertas.md | done (Feature 15: logging ✓ + validacion ✓ + alertas operativas en /alerts y vista dashboard ✓; ver ADR-009 sobre alertas como vista derivada) | M |
